...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/rest/private-get-order-detail
...
- `client_oid` (string) - Client Order ID. If not provided, order_id must be specified.
- `order_id` (string (int64)) - Order ID. string format is highly recommended, especially for JavaScript client. If not provided, client_oid must be specified.
...
openapi: 3.0.3
info:
  title: private/get-order-detail
  version: 1.0.0
servers:
  ...
  schemas:
    PrivateGetOrderDetailRequest:
      ...
      required:
        ...
        - nonce
        - params
      description: Request body for private/get-order-detail.
      properties:
        id:
          type: string
          format: int64
        ...
        method:
          type: string
          description: Must be "private/get-order-detail"
          example: private/get-order-detail
        api_key:
          type: string
        ...
        params:
          ...
          properties:
            order_id:
              ...
              format: int64
              example: "19848525"
              description: Order ID. string format is highly recommended, especially for JavaScript client. If not provided, client_oid must be specified.
            client_oid:
              type: string
              description: Client Order ID. If not provided, order_id must be specified.
    PrivateGetOrderDetailResponse:
      type: object
      description: |
        Response for private/get-order-detail (HTTP 200).
