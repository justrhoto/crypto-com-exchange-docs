...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/rest/private-staking-get-stake-history

- **Method:** `POST`
- **Path:** `/private/staking/get-stake-history`
- **Tags:** Staking
...
- `data` (array of object) - List of stake history entries.
  Array of objects:
  ...
  - `instrument_name` (string) - Staking instrument name, e.g. SOL.staked
  - `quantity` (string (decimal)) - Stake/unstake quantity. For yield-bearing instruments, in terms of original staked token. After unstaking, shows amount received (e.g. TON for TSTON.staked).
...
paths:
  /private/staking/get-stake-history:
    post:
      ...
      x-apply-to:
        - rest
      summary: private/staking/get-stake-history
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/PrivateStakingGetStakeHistoryRequest"
            example:
              id: "1"
              method: private/staking/get-stake-history
              api_key: YOUR_API_KEY
      ...
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/PrivateStakingGetStakeHistoryResponse"
              example:
                id: "1"
                method: private/staking/get-stake-history
                code: "0"
  ...
  schemas:
    PrivateStakingGetStakeHistoryRequest:
      ...
      required:
        ...
        - nonce
        - params
      description: Request body for private/staking/get-stake-history.
      properties:
        id:
          type: string
          format: int64
        ...
        method:
          type: string
          description: Must be "private/staking/get-stake-history"
          example: private/staking/get-stake-history
        api_key:
          type: string
    ...
    PrivateStakingGetStakeHistoryResponse:
      type: object
      description: |
        Response for private/staking/get-stake-history (HTTP 200/4xx/5xx).
      ...
      properties:
        ...
        result:
          type: object
          description: Present when code === 0. data array of stake history entries.
          properties:
            data:
              type: array
              description: List of stake history entries.
              items:
                $ref: "#/components/schemas/StakingStakeHistoryItem"
        message:
          type: string
    ...
    StakingStakeHistoryItem:
      type: object
      description: One stake history entry in private/staking/get-stake-history result.data.
      properties:
        instrument_name:
          type: string
          description: Staking instrument name, e.g. SOL.staked
        ...
        quantity:
          type: string
          format: decimal
          description: Stake/unstake quantity. For yield-bearing instruments, in terms of original staked token. After unstaking, shows amount received (e.g. TON for TSTON.staked).
        side:
