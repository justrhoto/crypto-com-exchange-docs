...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/rest/public-get-book
...
- `depth` (string **required**) - Number of bids and asks to return (up to 50)
...
- `data` (array of object)
  Array of objects:
  - `asks` (array of array of string (decimal))
  - `bids` (array of array of string (decimal))
- `depth` (string (int32)) - Number of bids and asks to return (up to 50)
...
```curl
curl -X GET "https://api.crypto.com/exchange/v1/public/get-book?instrument_name=BTCUSD-PERP&depth=10" \
...
components:
  schemas:
    PublicGetBookResponse:
      type: object
      description: |
        Response for public/get-book (HTTP 200/4xx/5xx).
      ...
      properties:
        ...
        result:
          type: object
          description: Present when code === 0. Order book. data is array of one object; bids/asks are [Price, Quantity, NumOrders].
          properties:
            depth:
              type: string
              format: int32
              ...
              items:
                ...
                properties:
                  bids:
                    type: array
                    items:
                      $ref: "#/components/schemas/BookSnapshotLevel"
                  asks:
                    type: array
                    items:
                      $ref: "#/components/schemas/BookSnapshotLevel"
