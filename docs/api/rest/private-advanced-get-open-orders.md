...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/rest/private-advanced-get-open-orders

- **Method:** `POST`
- **Path:** `/private/advanced/get-open-orders`
...
- `instrument_name` (string) - e.g. BTC_USD. Omit for 'all'.
...
openapi: 3.0.3
info:
  title: private/advanced/get-open-orders
  version: 1.0.0
servers:
...
paths:
  /private/advanced/get-open-orders:
    post:
      ...
      x-apply-to:
        - rest
      summary: private/advanced/get-open-orders
      description: |
        Gets all open orders for OTO/OTOCO orders for a particular instrument.
      operationId: privateAdvancedGetOpenOrders
      x-codeSamples: []
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/PrivateAdvancedGetOpenOrdersRequest"
            example:
              id: "1"
              method: private/advanced/get-open-orders
              api_key: YOUR_API_KEY
      ...
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/PrivateAdvancedGetOpenOrdersResponse"
              example:
                id: "1"
                method: private/advanced/get-open-orders
                code: "0"
  ...
  schemas:
    PrivateAdvancedGetOpenOrdersRequest:
      ...
      required:
        ...
        - nonce
        - params
      description: Request body for private/advanced/get-open-orders.
      properties:
        id:
          type: string
          format: int64
        ...
        method:
          type: string
          description: Must be "private/advanced/get-open-orders"
          example: private/advanced/get-open-orders
        api_key:
          type: string
        ...
        params:
          ...
          properties:
            instrument_name:
              type: string
              description: e.g. BTC_USD. Omit for 'all'.
    PrivateAdvancedGetOpenOrdersResponse:
      type: object
      description: |
        Response for private/advanced/get-open-orders (HTTP 200/4xx/5xx).
      ...
      properties:
        ...
        result:
          type: object
          description: Present when code === 0. result.data[] (OTO/OTOCO open orders).
          properties:
            data:
              type: array
              items:
