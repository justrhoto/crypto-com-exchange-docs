...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/rest/private-staking-unstake

- **Method:** `POST`
- **Path:** `/private/staking/unstake`
- **Tags:** Staking
...
- `instrument_name` (string **required**) - Staking instrument name, e.g. SOL.staked.
- `quantity` (string (decimal) **required**) - Unstake quantity. For yield-bearing instruments, quantity in terms of original staked token. E.g. for TSTON.staked, specify the TSTON.staked quantity to unstake; you will receive the equivalent in TON when the request completes.
...
- `quantity` (string (decimal)) - Unstake quantity. For yield-bearing instruments, in terms of original staked token. E.g. for TSTON.staked, this shows the quantity of TON you will receive when the request completes.
...
paths:
  /private/staking/unstake:
    post:
      ...
      x-apply-to:
        - rest
      summary: private/staking/unstake
      description: Create a request to unlock staked token.
      operationId: privateStakingUnstake
      x-codeSamples: []
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/PrivateStakingUnstakeRequest"
            example:
              id: "1"
              method: private/staking/unstake
              api_key: YOUR_API_KEY
      ...
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/PrivateStakingUnstakeResponse"
              example:
                id: "1"
                method: private/staking/unstake
                code: "0"
  ...
  schemas:
    PrivateStakingUnstakeRequest:
      ...
      required:
        ...
        - nonce
        - params
      description: Request body for private/staking/unstake.
      properties:
        id:
          type: string
          format: int64
        ...
        method:
          type: string
          description: Must be "private/staking/unstake"
          example: private/staking/unstake
        api_key:
          type: string
        ...
        params:
          ...
          properties:
            ...
            quantity:
              type: string
              format: decimal
              description: Unstake quantity. For yield-bearing instruments, quantity in terms of original staked token. E.g. for TSTON.staked, specify the TSTON.staked quantity to unstake; you will receive the equivalent in TON when the request completes.
    PrivateStakingUnstakeResponse:
      type: object
      description: |
        Response for private/staking/unstake (HTTP 200/4xx/5xx).
      ...
      properties:
        ...
        result:
          type: object
          description: Present when code === 0. staking_id, instrument_name, status, quantity, underlying_inst_name, reason.
          properties:
            staking_id:
              type: string
            ...
            quantity:
              type: string
              format: decimal
              description: Unstake quantity. For yield-bearing instruments, in terms of original staked token. E.g. for TSTON.staked, this shows the quantity of TON you will receive when the request completes.
