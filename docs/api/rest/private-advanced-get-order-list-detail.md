...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/rest/private-advanced-get-order-list-detail

- **Method:** `POST`
- **Path:** `/private/advanced/get-order-list-detail`
...
- `list_id_list` (array of string (int64) **required**) - List of list IDs to query. string format is highly recommended for JavaScript clients.

### Example

```json
{
  "method": "private/advanced/get-order-list-detail",
  "id": "1",
...
```json
{
  ...
  "result": {
    "data": [
      {
        "account_id": "5207a638-b79a-4c13-9d41-323be7556c17",
        "order_id": "289987352276367396",
        "client_oid": "289987352276367396",
        "order_type": "LIMIT",
        ...
        "order_value": "1000.0",
        "avg_price": "100000.00",
        "cumulative_quantity": "0.01000",
        "cumulative_value": "1000.0000000",
        "cumulative_fee": "-2.5",
        "status": "FILLED",
        "update_user_id": "5207a638-b79a-4c13-9d41-323be7556c17",
        "order_date": "2025-09-09",
        "instrument_name": "BTC_USD",
        "fee_instrument_name": "USD",
        "list_id": "4611686018427705309",
        "contingency_type": "SPOT_ATTACH",
        "leg_id": "1",
        "attach_order_id": "5755600460443882762",
        "create_time": "1757409908295",
        "create_time_ns": "1757409908295832533",
        "update_time": "1757430498603"
      },
      {
        "account_id": "5207a638-b79a-4c13-9d41-323be7556c17",
        "order_id": "289987352276367397",
        "client_oid": "289987352276367397",
...
openapi: 3.0.3
info:
  title: private/advanced/get-order-list-detail
  version: 1.0.0
servers:
...
paths:
  /private/advanced/get-order-list-detail:
    post:
      ...
      x-apply-to:
        - rest
      summary: private/advanced/get-order-list-detail
      description: |
        Gets order details for multiple OCO/SpotAttach orders by their list IDs.

        This endpoint allows batch querying of order information across different contingency order groups.
      operationId: privateAdvancedGetOrderListDetail
      x-codeSamples: []
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/PrivateAdvancedGetOrderListDetailRequest"
            example:
              method: private/advanced/get-order-list-detail
              id: "1"
              api_key: YOUR_API_KEY
      ...
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/PrivateAdvancedGetOrderListDetailResponse"
              example:
                id: "1"
                method: private/advanced/get-order-list-detail
                code: "0"
  ...
  schemas:
    PrivateAdvancedGetOrderListDetailRequest:
      ...
      required:
        ...
        - nonce
        - params
      description: Request body for private/advanced/get-order-list-detail.
      properties:
        id:
          type: string
          format: int64
        ...
        method:
          type: string
          description: Must be "private/advanced/get-order-list-detail"
          example: private/advanced/get-order-list-detail
        api_key:
          type: string
        ...
        params:
          ...
          properties:
            list_id_list:
              type: array
              description: List of list IDs to query. string format is highly recommended for JavaScript clients.
              items:
                type: string
                format: int64
    PrivateAdvancedGetOrderListDetailResponse:
      type: object
      description: |
        Response for private/advanced/get-order-list-detail (HTTP 200/4xx/5xx).
      ...
      properties:
        ...
        result:
          type: object
          description: Present when code === 0. result.data[] (order details by list_id).
          properties:
            data:
              type: array
              items:
