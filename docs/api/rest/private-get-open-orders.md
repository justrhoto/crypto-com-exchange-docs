...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/rest/private-get-open-orders
...
- `data` (array of object) - List of open orders.
  Array of objects:
...
paths:
  /private/get-open-orders:
    post:
      ...
      x-apply-to:
        - rest
      summary: private/get-open-orders
      description: Gets all open orders for a particular instrument.
      operationId: privateGetOpenOrders
      x-codeSamples: []
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/PrivateGetOpenOrdersRequest"
            example:
              id: "1"
              method: private/get-open-orders
              api_key: YOUR_API_KEY
  ...
  schemas:
    PrivateGetOpenOrdersRequest:
      ...
      required:
        ...
        - nonce
        - params
      description: Request body for private/get-open-orders.
      properties:
        id:
          type: string
          format: int64
        ...
        method:
          type: string
          description: Must be "private/get-open-orders"
    ...
    PrivateGetOpenOrdersResponse:
      type: object
      description: |
        Response for private/get-open-orders (HTTP 200/4xx/5xx).
      ...
      properties:
        ...
        result:
          type: object
          description: Present when code === 0. result.data[] per docs.
          properties:
            data:
              type: array
