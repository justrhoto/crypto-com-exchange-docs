...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/rest/private-amend-order
    ...
    post:
      ...
      requestBody:
        ...
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/PrivateAmendOrderRequest"
            example:
              id: "53"
              method: private/amend-order
              api_key: YOUR_API_KEY
