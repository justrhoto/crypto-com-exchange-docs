...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/websocket/ws-client-commands-heartbeat-request

- **Method:** `POST`
- **Path:** `/ws/request/clientCommands/HeartbeatRequest`
...
paths:
  /ws/request/clientCommands/HeartbeatRequest:
    post:
      operationId: ws-clientCommands-HeartbeatRequest
