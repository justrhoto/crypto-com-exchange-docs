...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/websocket/ws-market-data-client-commands-respond-heartbeat-request

- **Method:** `POST`
- **Path:** `/ws/request/marketDataClientCommands/RespondHeartbeatRequest`
...
paths:
  /ws/request/marketDataClientCommands/RespondHeartbeatRequest:
    post:
      operationId: ws-marketDataClientCommands-RespondHeartbeatRequest
