...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/websocket/ws-user-api-private-advanced-create-otoco

- **Method:** `POST`
- **Path:** `/ws/user-api/private/advanced/create-otoco`
...
- `order_list` (array of object **required**) - Exactly 3 orders. One must be LIMIT or MARKET; one trigger must be STOP_LOSS or STOP_LIMIT, the other TAKE_PROFIT or TAKE_PROFIT_LIMIT. ref_price_type supports MARK_PRICE (default), INDEX_PRICE, LAST_PRICE.
...
openapi: 3.0.3
info:
  title: private/advanced/create-otoco
  version: 1.0.0
servers:
...
paths:
  /ws/user-api/private/advanced/create-otoco:
    post:
      operationId: ws-user-api-privateAdvancedCreateOtoco
      summary: private/advanced/create-otoco
      description: |-
        Creates a One-Triggers-a-One-Cancels-the-Other (OTOCO) execution strategy on the Exchange.
      ...
      x-name: private/advanced/create-otoco
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/WsPrivateAdvancedCreateOtocoRequest"
            description: private/advanced/create-otoco
            example:
              method: private/advanced/create-otoco
              id: "123456789"
              nonce: "123456789000"
      ...
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/WsPrivateAdvancedCreateOtocoResponse"
              examples:
                Success:
                  value:
                    id: "1661331443"
...
components:
  schemas:
    WsPrivateAdvancedCreateOtocoRequest:
      type: object
      x-archetype: Request
      required:
        - id
        ...
        - nonce
        - params
      description: Request body for private/advanced/create-otoco.
      properties:
        id:
          type: string
          format: int64
        ...
        method:
          type: string
          description: Must be "private/advanced/create-otoco"
          example: private/advanced/create-otoco
        nonce:
          type: string
          format: int64
        ...
        params:
          ...
          properties:
            order_list:
              ...
              minItems: 3
              maxItems: 3
              description: Exactly 3 orders. One must be LIMIT or MARKET; one trigger must be STOP_LOSS or STOP_LIMIT, the other TAKE_PROFIT or TAKE_PROFIT_LIMIT. ref_price_type supports MARK_PRICE (default), INDEX_PRICE, LAST_PRICE.
              items:
    ...
    WsPrivateAdvancedCreateOtocoResponse:
      $ref: "#/components/schemas/PrivateAdvancedCreateOtocoResponse"
    PrivateAdvancedCreateOtocoResponse:
      type: object
      description: |
        Response for private/advanced/create-otoco (HTTP 200/4xx/5xx).
