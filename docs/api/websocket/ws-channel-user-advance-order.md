...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/websocket/ws-channel-user-advance-order

CHANNEL 

## wss://stream.crypto.com/exchange/v1/user

user.advance.orderPrivate

OTO/OTOCO order updates. Subscribe with channel \["user.advance.order"\].
