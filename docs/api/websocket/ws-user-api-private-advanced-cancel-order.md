...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/websocket/ws-user-api-private-advanced-cancel-order

- **Method:** `POST`
- **Path:** `/ws/user-api/private/advanced/cancel-order`
...
openapi: 3.0.3
info:
  title: private/advanced/cancel-order
  version: 1.0.0
servers:
...
paths:
  /ws/user-api/private/advanced/cancel-order:
    post:
      operationId: ws-user-api-privateAdvancedCancelOrder
      summary: private/advanced/cancel-order
      description: |-
        Cancel an individual order of a OTO/OTOCO order on the Exchange (asynchronous). 
      ...
      x-name: private/advanced/cancel-order
      requestBody:
        required: true
        content:
          application/json:
            schema:
              $ref: "#/components/schemas/WsPrivateAdvancedCancelOrderRequest"
            description: private/advanced/cancel-order
            example:
              id: "1"
              nonce: "1610905028000"
              method: private/advanced/cancel-order
      ...
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/WsPrivateAdvancedCancelOrderResponse"
              examples:
                Success:
                  value:
                    id: "1"
...
components:
  schemas:
    WsPrivateAdvancedCancelOrderRequest:
      type: object
      x-archetype: Request
      required:
        - id
        ...
        - nonce
        - params
      description: Request body for private/advanced/cancel-order.
      properties:
        id:
          type: string
          format: int64
        ...
        method:
          type: string
          description: Must be "private/advanced/cancel-order"
          example: private/advanced/cancel-order
        nonce:
          type: string
          format: int64
    ...
    WsPrivateAdvancedCancelOrderResponse:
      $ref: "#/components/schemas/PrivateAdvancedCancelOrderResponse"
    PrivateAdvancedCancelOrderResponse:
      type: object
      description: |
        Response for private/advanced/cancel-order (HTTP 200/4xx/5xx).
