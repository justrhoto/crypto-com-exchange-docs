...
URL: https://exchange-developer.crypto.com/exchange/v1/docs/api/websocket/ws-channel-funding-instrument-name

- **Method:** `POST`
- **Path:** `/ws/channel/funding-instrument-name`
...
- `channels` (array of string **required**) - e.g. ["funding.BTCUSD-PERP"]
...
paths:
  /ws/channel/funding-instrument-name:
    post:
      operationId: ws-channel-funding-instrument-name
      summary: funding.{instrument_name}
      description: Hourly funding rate that will settle at end of current hour. Subscribe e.g. ["funding.BTCUSD-PERP"].
      tags:
        - Websocket Market Data
      x-type: channel
      x-channel-url: wss://stream.crypto.com/exchange/v1/market
      x-channel-group: marketData
      x-name: funding.{instrument_name}
      requestBody:
        required: true
        content:
          application/json:
                ...
                params:
                  ...
                  properties:
                    channels:
                      ...
                      items:
                        type: string
                      description: e.g. ["funding.BTCUSD-PERP"]
                      example:
                        - funding.BTCUSD-PERP
                nonce:
                  type: integer
      ...
      responses:
        "200":
          ...
          content:
            application/json:
              schema:
                $ref: "#/components/schemas/WsFundingPayload"
              example:
                id: 1
                method: subscribe
                code: 0
